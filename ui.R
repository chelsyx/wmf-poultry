    ...
    tabItems(
      ...
      tabItem(tabName = "all_country",
              fluidRow(
               ...
               shiny::column(width = 4,
                 conditionalPanel("input.cntr_sort_a == 'custom_a'", 
                   selectizeInput("cntr_a", "Countries", choices=sort(unique(all_country_data$country)), selected=c("United Kingdom","U.S. (Midwest)","U.S. (Pacific)","U.S. (Northeast)","U.S. (South)"), multiple = TRUE))),
	             shiny::column(width = 2,
              ...
              fluidRow(
                shiny::column(width=4,		
                  googleChartsInit(),
                  googlePieChart("traffic_pie_pl",
                    width="100%", height = "500px",
                    options = list(legend = 'none',
						           pieSliceText = 'label',
						           sliceVisibilityThreshold = 0,
						           backgroundColor='transparent',
						           chartArea = list(top = 20, left = 0, bottom=5, height = "100%", width = "100%")))
                ),
              ...
              fluidRow(
                ...
                shiny::column(width = 4,
                  conditionalPanel("input.cntr_sort_f == 'custom_f'", 
                    selectizeInput("cntr_f", "Countries", choices=sort(unique(all_country_data$country)), selected=c("United Kingdom","U.S. (Midwest)","U.S. (Pacific)","U.S. (Northeast)","U.S. (South)"), multiple = TRUE))),
                shiny::column(width = 2,
                ...
                fluidRow(  
                  shiny::column(width=4,		
                    googleChartsInit(),
                    googlePieChart("first_visit_pie_pl",
                      width="100%", height = "500px",
                      options = list(legend = 'none',
                                     pieSliceText = 'label',
                                     sliceVisibilityThreshold = 0,
              ...
              fluidRow(
                ...
                shiny::column(width = 4,
                  conditionalPanel("input.cntr_sort_l == 'custom_l'", 
                    selectizeInput("cntr_l", "Countries", choices=sort(unique(all_country_data$country)), selected=c("United Kingdom","U.S. (Midwest)","U.S. (Pacific)","U.S. (Northeast)","U.S. (South)"), multiple = TRUE))),
                shiny::column(width = 2,
                ...
                fluidRow(  
                  shiny::column(width=4,		
                    googleChartsInit(),
                    googlePieChart("last_action_pie_pl",
                      width="100%", height = "500px",
                      options = list(legend = 'none',
                                     pieSliceText = 'label',
                                     sliceVisibilityThreshold = 0,
              ...
              fluidRow(
                ...
                shiny::column(width = 4,
                  conditionalPanel("input.cntr_sort_m == 'custom_m'", 
                    selectizeInput("cntr_m", "Countries", choices=sort(unique(all_country_data$country)), selected=c("United Kingdom","U.S. (Midwest)","U.S. (Pacific)","U.S. (Northeast)","U.S. (South)"), multiple = TRUE))),
                shiny::column(width = 2,
                ...
                fluidRow(  
                  shiny::column(width=4,		
                    googleChartsInit(),
                    googlePieChart("most_common_pie_pl",
                      width="100%", height = "500px",
                      options = list(legend = 'none',
                                     pieSliceText = 'label',
                                     sliceVisibilityThreshold = 0,
